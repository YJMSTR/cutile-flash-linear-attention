...
from fla_paddle.ops.common.chunk_delta_h import chunk_gated_delta_rule_bwd_dhu, chunk_gated_delta_rule_fwd_h
from fla_paddle.ops.kda.chunk_intra import chunk_kda_bwd_intra
from fla_paddle.ops.kda.gate import kda_gate_bwd, kda_gate_chunk_cumsum
from fla_paddle.ops.kda.wy_fast import recompute_w_u_fwd
from fla_paddle.ops.utils import chunk_local_cumsum, prepare_chunk_indices
from fla_paddle.ops.utils.constant import RCP_LN2
from fla_paddle.ops.utils.op import exp2
from fla_paddle.utils import (
    IS_NVIDIA_HOPPER,
...
def chunk_kda_bwd(
    ...
    **kwargs,
    ...
    if cp_context is not None:
        raise NotImplementedError("CP not supported in paddle migration")
