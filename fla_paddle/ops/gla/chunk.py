# Only the chunk_gla_fwd_o_gk function and its kernel, extracted from fla/ops/gla/chunk.py
#
...
from fla_paddle.utils import autotune_cache_kwargs, check_shared_mem
