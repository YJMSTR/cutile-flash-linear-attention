...
from fla_paddle.ops.utils.op import make_tensor_descriptor
from fla_paddle.utils import IS_TMA_SUPPORTED, autotune_cache_kwargs, input_guard
...
def solve_tril(
    ...
    Ai = paddle.zeros_like(A).cast(output_dtype)
    if BT == 16:
