...
class FrameworkTracker:
    ...
    def detect_triton_driver(self) -> str:
        ...
        from fla_paddle.triton_utils import get_driver_probe_result
    ...
    def _detect_triton_driver_snapshot() -> str:
        ...
        try:
            ...
            from fla_paddle.triton_utils import _detect_driver_framework
...
def _driver_probe_lifecycle():
    ...
    if os.environ.get("FLA_BENCHMARK", "0") == "1":
        yield
        return
    from fla_paddle.triton_utils import enable_driver_probe, disable_driver_probe
    enable_driver_probe()
    yield
